...
class BinaryRecommendEnv(object):
    ...
    def _get_cand(self):
        ...
        cand_item = self._map_to_all_id(self.cand_items,'item')
        if self.ask_open:
    ...
    def _get_action_space(self):
        if self.ask_open:
            action_space = [self._map_to_all_id([self.target_item],'feature'),self._map_to_all_id(self.cand_items,'item')]
        else:
            action_space = [self._map_to_all_id(self.cand_items,'item')]
        return action_space
