...
def pai_evaluate(args, kg, dataset, filename,agent,difficulty):
    test_env = EnvDict[args.data_name](kg, dataset, args.data_name, args.embed,args.data_type, master_level='',seed=args.seed, max_turn=args.max_turn,
...
def main():
    ...
    parser.add_argument('--max_turn', type=int, default=16, help='max conversation turn')
    ...
    parser.add_argument('--mastery', type=str, default='com-sorted3', help='the type of data')
